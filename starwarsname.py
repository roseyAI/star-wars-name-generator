...
firstName = st.text_input("Enter your first name:", key="first_name").title()
lastName = st.text_input("Enter your last name:", key="last_name").lower()
maidenName = st.text_input("Enter your mother's maiden name:", key="maiden_name").title()
cityName = st.text_input("Enter the city you were born:", key="city_name").lower()
